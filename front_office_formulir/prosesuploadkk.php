...
if (isset($_POST['uploadkk'])) {
    ...
    if($rvpendaftaran>0){
    $qrupdate = mysqli_query($koneksi, "UPDATE tbl_berkas SET fc_kk='$file_upload' WHERE nik='$id'") or die(mysqli_error($koneksi));
    ...
    $qrtambah = mysqli_query($koneksi, "INSERT INTO tbl_berkas VALUES (null, null, null, '$file_upload', null,'$id', '$nama')") or die(mysqli_error($koneksi));
