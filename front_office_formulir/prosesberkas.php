...
if (isset($_POST['daftar'])) {
    ...
    <script>
        ...
        setTimeout(function(){window.location.href = "berkas.php";}, 1500);
    </script>'
    <?php
    }
    else {

    $tmbhsntri = mysqli_query($koneksi,"INSERT INTO tbl_berkas VALUES(null,'$file_upload','$file_upload1','$file_upload2','$file_upload3','$nik')") or die (mysqli_error($koneksi));
