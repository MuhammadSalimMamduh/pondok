                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-header" style="background-color: #b5ab70;">
                                    <h3 class="card-title">
                                        <font color="#ffffff"><i class="nav-icon fas fa-file"></i> &nbsp Kode Formulir</font>
                                    </h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <form action="prosestambah.php" method="post">
                                        <a href="../backoffice_rekening" class="btn btn-secondary btn-sm"><i class="nav-icon fas fa-chevron-left"></i> Kembali</a>
                            ...
                            <table>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td width="5%">:</td>
                                        <td>
                                            <input type="text" name="ed_userterpilih" class="form-control" disabled>
                                        </td>
                                    </tr>
                                    <tr>
