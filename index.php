...
<head>
  ...
  <!-- site metas -->
  <title>PONDOK RIBATH AL-MUSYAROH</title>
  <meta name="keywords" content="">
  <meta name="description" content="">
  <meta name="author" content="">
  <!-- fevicon -->
  <link rel="icon" href="assets_frontend/images/pondok.png" />
  <!-- bootstrap css -->
  <link rel="stylesheet" href="assets_frontend/css/bootstrap.min.css">
  <!-- style css -->
  <link rel="stylesheet" href="assets_frontend/css/style.css">
  <!-- Responsive-->
  <link rel="stylesheet" href="assets_frontend//responsive.css">
  <!-- Scrollbar Custom CSS -->
  <link rel="stylesheet" href="assets_frontend/css/jquery.mCustomScrollbar.min.css">
...
<body class="main-layout">
  <!-- loader  -->
  <div class="loader_bg">
    <div class="loader"><img src="assets_frontend/images/loading.gif" alt="#" /></div>
  </div>
  <!-- end loader -->
  <!-- header -->
  <header>
          ...
          <div class="row">
            <div class="col-xl-2 col-lg-4 col-md-4 col-sm-3 col logo_section">
              <div class="full">
                <div class="center-desk">
                  <div class="logo">
                    <a href="index.html"><img src="assets_frontend/images/logo.png" alt="#" /></a>
                  </div>
                </div>
              </div>
            </div>
            <div class="col-xl-10 col-lg-8 col-md-8 col-sm-9">
              <div class="header_information">
                  ...
                  <div class="limit-box">
                    <nav class="main-menu ">
                      <ul class="menu-area-main">
                        ...
                        <li> <a href="#learn">Profil</a> </li>
                        <li> <a href="front_office_formulir" target="_blank">Pendaftaran</a> </li>
                ...
                <div class="mean-last">
                <li><a href="login" target="_blank">Login (Hanya untuk Admin)</a></li>
                  <!-- <a href="login"><img src="assets_frontend/images/search_icon.png" alt="#"></a> <a href="login" target="_blank">login</a> -->
                </div>
              </div>
            </div>
          </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-xl-7 col-lg-7 col-md-7 col-sm-12">
                      <div class="images_box">
                        <figure><img src="assets_frontend/images/img2.png"></figure>
                      </div>
                    </div>
                  </div>
                </div>
  ...
  <div id="about" class="about">
    <div class="container">
      <div class="row">
        ...
        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
          <div class="about-box">
            <figure><img src="assets_frontend/images/about.jpg" alt="#" /></figure>
          </div>
        </div>
      </div>
          ...
          <div class="box_bg">
            <div class="box_bg_img">
              <div class="row">
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                  <div class="box_my">
                    <figure><img src="assets_frontend/images/my1.jpg"></figure>
                    <div class="overlay">
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                  <div class="box_my">
                    <figure><img src="assets_frontend/images/my2.jpg"></figure>
                    <div class="overlay">
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                  <div class="box_my">
                    <figure><img src="assets_frontend/images/my3.jpg"></figure>
                    <div class="overlay">
                      <h3>Skills</h3>
                      <p>It is a long established fact that a reader will be distracted by the readable content o</p>
                    </div>
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                  <div class="box_my">
                    <figure><img src="assets_frontend/images/my4.jpg"></figure>
                    <div class="overlay">
  ...
  <div id="learn" class="learn">
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="learn_box">
            <figure><img src="assets_frontend/images/img.jpg" alt="img" /></figure>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="make">
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-xl-5 col-lg-5 col-md-5 col-sm-12">
          <div class="make_img">
            <figure><img src="assets_frontend/images/make_img.jpg"></figure>
          </div>
        </div>
      </div>
    </div>
  ...
  <div id="contact" class="contact">
              ...
              <div class="row">
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 ">
                  <div class="address">
                    ...
                    <ul class="loca">
                      <li>
                        <a href="#"><img src="assets_frontend/icon/loc.png" alt="#" /></a>London 145
                        <br>United Kingdom
                      </li>
                      <li>
                        <a href="#"><img src="assets_frontend/icon/email.png" alt="#" /></a>demo@gmail.com
                      </li>
                      <li>
                        <a href="#"><img src="assets_frontend/icon/call.png" alt="#" /></a>+12586954775
                      </li>
                    </ul>
                    <ul class="social_link">
                      <li><a href="#"><img src="assets_frontend/icon/fb.png"></a></li>
                      <li><a href="#"><img src="assets_frontend/icon/tw.png"></a></li>
                      <li><a href="#"><img src="assets_frontend/icon/lin(2).png"></a></li>
                      <li><a href="#"><img src="assets_frontend/icon/instagram.png"></a></li>
                    </ul>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 ">
                  <div class="address">
                    <a href="index.html"> <img src="assets_frontend/images/logo1.jpg" alt="logo"></a>
                  </div>
                </div>
              </div>
            </div>
    ...
    <script src="assets_frontend/js/jquery-3.0.0.min.js"></script>
    <script src="assets_frontend/js/plugin.js"></script>
    <!-- sidebar -->
    <script src="assets_frontend/js/jquery.mCustomScrollbar.concat.min.js"></script>
    ...
    <script>
      ...
      function initMap() {
        ...
        var image = 'assets_frontend/images/maps-and-flags.png';
