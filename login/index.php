    ...
    <div class="session-wrapper">
      <div class="session-carousel slide" data-ride="carousel" data-interval="3000">
        ...
        <div class="carousel-inner" role="listbox">
          <div class="item active" style="background-image:url(/img/foto.webp);background-size:cover;background-repeat: no-repeat;background-position: 50% 50%;">
          </div>
      ...
      <div class="card bg-white  blue no-border" style="background-color:#ffffff;">
        <div class="card-block">
          ...
          <br>
          <center><font color="#000000"><small><em> Copyright &copy; PONDOK RIBATH AL-MUSYARAFFAH </a></em></</small></font>
          <br/>  
          ...
          if(isset($koneksi, $_POST['masuk'])){
            ...
            echo '<script>window.location="../back_office"</script>';
            }
            else{
